package com.xudongxu.aianswer.service.impl;
...
import com.xudongxu.aianswer.constant.CommonConstant;
import com.xudongxu.aianswer.exception.ThrowUtils;
import com.xudongxu.aianswer.mapper.ScoringResultMapper;
...
import com.xudongxu.aianswer.model.vo.UserVO;
...
import com.xudongxu.aianswer.utils.SqlUtils;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (StringUtils.isNotBlank(resultName)) {
            ThrowUtils.throwIf(resultName.length() > 128, ErrorCode.PARAMS_ERROR, "结果名过长");
        }
        if (appId != null) {
